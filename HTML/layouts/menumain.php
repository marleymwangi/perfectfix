<ul class="list-unstyled s-header__nav-menu">
    ...
    <?php 
     ...
     ?>
    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-color--primary g-margin-l-70--xs g-margin-t-40--xs g-font-weight--400 <?php if ($page=='services') {echo'-is-active'; }?>" href="contacts.php">Contact Us</a></li>
    <?php 
        if (isset($_SESSION['userName'])) {
