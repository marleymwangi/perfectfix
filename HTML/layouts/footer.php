                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 g-margin-b-40--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                ...
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="privacy.php">Privacy Policy</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="terms&conditions.php">Terms &amp; Conditions</a></li>
                            </ul>
                        </div>
            ...
            <div class="container g-padding-y-50--xs">
                <div class="row">
                    ...
                    <div class="col-xs-6 g-text-right--xs">
                        <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white-opacity-light"><a href="http://keenthemes.com/preview/Megakit/">PerfectFix</a> Prediction Powered by: <a href="http://www.perfectfix.co/">perfectfix.co</a></p>
                    </div>
                </div>
            </div>
            <!-- End Copyright -->
